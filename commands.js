...
module.exports = function(ChunkBot) {
	...
	ChunkBot.config.botIdent = "Cuck Bot intiating cuckolding now";
	...
	*/
	...
	ChunkBot.addCommand({ // Test command.
		...
		text: /.*\bbot\b.*\b(dance|boog(y|ie)|twerk|fire|crank dat|emoji-1f525)\b.*/ig,
		title: "bot dance",
    	...
    	text: /bot stopbeinggay?/i,
    	callback: function(data) {
        	ChunkBot.say("Only one more dick!");
    	}
	});
